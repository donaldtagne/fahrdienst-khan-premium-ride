...
export const translations: Record<Lang, Dict> = {
  de: {
    ...
    "faq.q5": "Gibt es Festpreise oder wird nach Taxameter abgerechnet?",
    "faq.a5": "Für die meisten Strecken bieten wir transparente Festpreise vorab – ohne Überraschungen. Sehen Sie unsere beliebten Strecken oder fragen Sie individuell an.",
    "faq.q6": "Kann ich kostenfrei stornieren?",
    "faq.a6": "Ja. Stornierungen sind über die Webseite bis 24 Stunden vor Abholung kostenfrei möglich. Kurzfristige Änderungen bitte telefonisch.",
    "faq.q7": "Kinder, Gepäck, Kindersitz – was ist möglich?",
    "faq.a7": "Auf Wunsch stellen wir einen Kindersitz kostenfrei zur Verfügung. Großes Gepäck und Sportausrüstung sind kein Problem – bitte bei der Buchung kurz erwähnen.",
    "faq.q8": "Wie funktioniert die Bezahlung bei Geschäftskunden?",
    "faq.a8": "Geschäftskunden erhalten auf Wunsch eine monatliche Sammelrechnung mit ausgewiesener MwSt. – ideal für die Buchhaltung.",

    "price.eyebrow": "Festpreisrechner",
    "price.title": "Was kostet Ihre Fahrt?",
    "price.route": "Strecke wählen",
    "price.other": "Andere Strecke (Kilometer angeben)",
    "price.km": "Entfernung in km",
    "price.flat": "Festpreis",
    "price.night": "Nachtfahrt (22–6 Uhr) +15%",
    "price.book": "Jetzt buchen",
    "price.disclaimer": "Preis ist ein Festpreis inkl. MwSt. für eine Standardfahrt. Nachtzuschlag (22–6 Uhr) und Aufschlag ab 5 Personen werden berücksichtigt. Bei mehreren Stopps, Wartezeit oder besonderen Anforderungen erhalten Sie ein individuelles Angebot.",

    "routes.title": "Beliebte Strecken",
    "routes.subtitle": "Transparente Festpreise",
    "routes.viewAll": "Alle Strecken & Preise",

    "trust.eyebrow": "Vertrauen & Sicherheit",
    "trust.title": "Warum Sie ruhig schlafen können",
    "trust.insurance.t": "Voll versichert",
    "trust.insurance.d": "Alle Fahrgäste sind während der Fahrt umfassend versichert.",
    "trust.license.t": "Personenbeförderungsschein",
    "trust.license.d": "Konzessioniert nach PBefG – legal, geprüft, professionell.",
    "trust.uber.t": "Uber Partner",
    "trust.uber.d": "Offizieller Partner mit überprüftem Profil und Top-Bewertungen.",
    "trust.247.t": "24/7 erreichbar",
    "trust.247.d": "Tag und Nacht, an 365 Tagen im Jahr – auch an Feiertagen.",
    "trust.pay.t": "Flexible Bezahlung",
    "trust.pay.d": "Bar, EC-Karte, Rechnung für Firmen – wie es Ihnen passt.",
    "trust.exp.t": "10+ Jahre Erfahrung",
    "trust.exp.d": "Über 2.000 erfolgreiche Fahrten in der Region Rhein-Neckar.",

    "area.eyebrow": "Servicegebiet",
    "area.title": "Frankenthal & Rhein-Neckar",
    "area.desc": "Unser Stammgebiet ist Frankenthal und die gesamte Metropolregion. Für Langstrecken und Flughafentransfers fahren wir deutschlandweit.",
    "area.citiesLabel": "Städte im Stammgebiet",
    "area.airportsLabel": "Flughäfen",
    "area.region": "Metropolregion Rhein-Neckar",

    "biz.eyebrow": "Geschäftskunden",
    "biz.title": "Premium Mobilität für Ihr Unternehmen",
    "biz.desc": "Sammelrechnung, fester Ansprechpartner, priorisierte Verfügbarkeit. Wir bewegen Ihr Team und Ihre Gäste – mit der Diskretion und Pünktlichkeit, die Sie erwarten.",
    "biz.cta": "Mehr erfahren",
    "biz.perk1": "Monatliche Rechnung mit MwSt.",
    "biz.perk2": "Termine fest blockierbar",
    "biz.perk3": "Empfang internationaler Gäste",
    "biz.perk4": "Rahmenvertrag möglich",

    "booking.flight": "Flugnummer (optional)",
    "booking.recurring": "Wiederkehrende Fahrt (z. B. wöchentlich)",
  ...
  en: {
    ...
    "admin.title": "Reservations",
    "admin.loginTitle": "Admin Access",
    "admin.loginDesc": "Enter your PIN to manage reservations.",
    "admin.pinPlaceholder": "Enter PIN",
    "admin.enter": "Access",
    "admin.logout": "Logout",
    "admin.authError": "Invalid PIN. Please try again.",
    "admin.noReservations": "No reservations found.",
    ...
    "faq.q5": "Are prices flat or metered?",
    "faq.a5": "For most routes we offer transparent flat prices upfront – no surprises. See our popular routes or request a custom quote.",
    "faq.q6": "Can I cancel for free?",
    "faq.a6": "Yes. Cancellations via the website are free up to 24 hours before pickup. For short-notice changes please call us.",
    "faq.q7": "Children, luggage, child seat – what is possible?",
    "faq.a7": "A child seat is available free of charge on request. Large luggage and sports gear are no problem – just mention it when booking.",
    "faq.q8": "How does payment work for business clients?",
    "faq.a8": "Business clients can receive a monthly consolidated invoice with VAT – ideal for bookkeeping.",

    "price.eyebrow": "Flat price calculator",
    "price.title": "What does your ride cost?",
    "price.route": "Select route",
    "price.other": "Other route (enter kilometres)",
    "price.km": "Distance in km",
    "price.flat": "Flat price",
    "price.night": "Night ride (10pm–6am) +15%",
    "price.book": "Book now",
    "price.disclaimer": "Price is a flat fee incl. VAT for a standard ride. Night surcharge (10pm–6am) and a surcharge for 5+ passengers are included. Multi-stop, waiting time or special requirements receive an individual quote.",

    "routes.title": "Popular routes",
    "routes.subtitle": "Transparent flat prices",
    "routes.viewAll": "All routes & prices",

    "trust.eyebrow": "Trust & safety",
    "trust.title": "Why you can rest easy",
    "trust.insurance.t": "Fully insured",
    "trust.insurance.d": "Every passenger is comprehensively insured during the ride.",
    "trust.license.t": "Passenger transport licence",
    "trust.license.d": "Licensed under the German PBefG – legal, audited, professional.",
    "trust.uber.t": "Uber Partner",
    "trust.uber.d": "Official partner with verified profile and top ratings.",
    "trust.247.t": "24/7 reachable",
    "trust.247.d": "Day and night, 365 days a year – including holidays.",
    "trust.pay.t": "Flexible payment",
    "trust.pay.d": "Cash, debit card, invoice for companies – however you like.",
    "trust.exp.t": "10+ years of experience",
    "trust.exp.d": "Over 2,000 successful rides in the Rhine-Neckar region.",

    "area.eyebrow": "Service area",
    "area.title": "Frankenthal & Rhine-Neckar",
    "area.desc": "Our home turf is Frankenthal and the entire metropolitan region. For long-distance and airport rides we drive nationwide.",
    "area.citiesLabel": "Cities in our home area",
    "area.airportsLabel": "Airports",
    "area.region": "Rhine-Neckar metropolitan area",

    "biz.eyebrow": "Business clients",
    "biz.title": "Premium mobility for your company",
    "biz.desc": "Consolidated invoice, dedicated contact, priority availability. We move your team and guests – with the discretion and punctuality you expect.",
    "biz.cta": "Learn more",
    "biz.perk1": "Monthly invoice with VAT",
    "biz.perk2": "Recurring slots reservable",
    "biz.perk3": "International guest pickup",
    "biz.perk4": "Framework contracts available",

    "booking.flight": "Flight number (optional)",
    "booking.recurring": "Recurring trip (e.g. weekly)",
