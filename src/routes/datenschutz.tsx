  ...
  return (
    <PageLayout>
      ...
      <section className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8 space-y-6 text-foreground/80">
        <h2 className="font-display text-2xl text-navy">1. Verantwortlicher</h2>
        <p>{CONTACT.name}, Kaulaverling 33, 67227 Frankenthal, Telefon: {CONTACT.phone}, E-Mail: {CONTACT.email}.</p>

        <h2 className="font-display text-2xl text-navy">2. Erhebung und Speicherung personenbezogener Daten</h2>
        ...
        <h2 className="font-display text-2xl text-navy">3. Kontaktformular & Fahrtanfrage</h2>
        ...
        <h2 className="font-display text-2xl text-navy">4. Ihre Rechte</h2>
        ...
        <h2 className="font-display text-2xl text-navy">5. Google Maps</h2>
