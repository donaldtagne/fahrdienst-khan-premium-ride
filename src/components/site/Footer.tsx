...
export function Footer() {
  const { t } = useI18n();
  return (
    <footer className="relative border-t border-border bg-muted text-foreground">
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-4 lg:px-8">
        <div className="lg:col-span-2">
          <div className="flex items-center gap-2">
            <span className="grid h-10 w-10 place-items-center rounded-md border border-white/15 bg-gradient-to-br from-white/15 to-white/5 font-display text-lg text-gradient-platinum">K</span>
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-center gap-4 px-4 py-6 sm:flex-row sm:justify-between sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="flex items-center gap-3">
              ...
              {/* Cash / Bar */}
              <div className="flex items-center gap-1 rounded bg-foreground/5 px-2 py-1 text-[10px] font-semibold text-foreground/80">
